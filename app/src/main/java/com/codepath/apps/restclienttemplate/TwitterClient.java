...
public class TwitterClient extends OAuthBaseClient {
	...
	public void getHomeTimelime(JsonHttpResponseHandler handler) {
	...
	public void favoriteTweet(JsonHttpResponseHandler handler, boolean favoriteOrNot, long tweetID) {
		if (favoriteOrNot) {
	...
	public void retweet(JsonHttpResponseHandler handler, boolean retweetOrNot, long tweetID) {
		if (retweetOrNot) {
